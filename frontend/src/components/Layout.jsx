import { Outlet, Link, useLocation } from 'react-router-dom'; // Removed useNavigate
          ...
          <div className="flex items-center justify-between ">
            ...
            <div className="flex items-center">
              <div className="flex items-center ml-3">
                ...
                <Link
                  to="/change-password"
                  className="flex items-center p-2 text-gray-600 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 mr-2"
                  title="Alterar Senha"
                >
